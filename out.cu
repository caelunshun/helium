...
struct MainloopFusion {
    ...
    __device__ void apply_thr_a(TensorA &tensor_a) {
        transform(tensor_a, [](auto x) {
            ...
            return static_cast<decltype(x)>(local0);
        });
    }
    ...
    __device__ void apply_thr_b(TensorB &tensor_b) {
         transform(tensor_b, [](auto x) {
            ...
            return static_cast<decltype(x)>(local1);
        });
    }
};
...
struct Epilogue {
    ...
    __device__ void apply_tile_c(TensorC tensor_c) {
        ...
        {
    const auto coord_c = make_coord(blockIdx.x, blockIdx.y);
    auto layout_gmem_out = Layout<Shape<Int<4096>, Int<4096>>, Stride<Int<4096>, Int<1>>>{};
    ...
    auto tiled_copy = make_tiled_copy(Copy_Atom<UniversalCopy<uint16_t>, half_t>{},
        Layout<Shape<Int<2>, Int<128>>, Stride<Int<128>, Int<1>>>{},
        Layout<Shape<Int<64>, Int<1>>, Stride<Int<1>, Int<1>>>{});
    ...
    auto thr_reg_c_converted = make_tensor<half_t>(thr_reg_c.layout());
    transform(thr_reg_c, thr_reg_c_converted, [](auto x) {
        float local2 = static_cast<float>(x);
        float local3 = local2;
        return static_cast<half_t>(local3);
    });
...
extern "C" __global__ __launch_bounds__(256) void matmul(half_t *a, half_t *b, half_t *leaf0) {
    using TileSize = Shape<Int<128>, Int<128>, Int<32>>;

    auto tiled_copy_g2s_a = make_tiled_copy(Copy_Atom<SM80_CP_ASYNC_CACHEGLOBAL<uint128_t>, half_t>{}, Layout<Shape<Int<64>, Int<4>>, Stride<Int<4>, Int<1>>>{}, Layout<Shape<Int<2>, Int<8>>, Stride<Int<8>, Int<1>>>{});
    auto tiled_copy_g2s_b = make_tiled_copy(Copy_Atom<SM80_CP_ASYNC_CACHEGLOBAL<uint128_t>, half_t>{}, Layout<Shape<Int<16>, Int<16>>, Stride<Int<1>, Int<16>>>{}, Layout<Shape<Int<8>, Int<2>>, Stride<Int<1>, Int<8>>>{});
    ...
    auto tiled_copy_s2r_b = make_tiled_copy_B(Copy_Atom<SM75_U16x8_LDSM_T, half_t>{}, tiled_mma);
    
    using MatmulInstance = Matmul<half_t, half_t, half_t, half_t, float,
        float, Layout<Shape<Int<4096>, Int<4096>>, Stride<Int<4096>, Int<1>>>, Layout<Shape<Int<4096>, Int<4096>>, Stride<Int<1>, Int<4096>>>, MainloopFusion, Epilogue<TileSize>,
        TileSize, Layout<Shape<Int<128>, Int<32>>, Stride<Int<40>, Int<1>>>, Layout<Shape<Int<128>, Int<32>>, Stride<Int<1>, Int<136>>>, Layout<Shape<Int<128>, Int<128>>, Stride<Int<1>, Int<132>>>, decltype(tiled_copy_g2s_a),
        decltype(tiled_copy_g2s_b), decltype(tiled_copy_s2r_a), decltype(tiled_copy_s2r_b),
        decltype(tiled_mma), 2, true, true>;
